...
for (const required of [
  ...
  "Features/Classroom/MiniProgramClassCreateView.swift",
  "Features/Classroom/MiniProgramStudentCreateView.swift",
  ...
  "Features/Learning/MiniProgramLearningCreateView.swift",
...
for (const [file, labels] of Object.entries({
  ...
  "ClassTrace/Features/Classroom/MiniProgramClassCreateView.swift": ["班级信息", "上课时间", "固定排课", "自由排课", "单次课费", "单次时长", "预付课时"],
  "ClassTrace/Features/Classroom/MiniProgramStudentCreateView.swift": ["学生信息", "加入班级", "基础课时", "备注信息", "保存学生信息"],
  "ClassTrace/Features/Learning/MiniProgramLearningCreateView.swift": ["发送对象", "指定学生", "作业附件", "计划类型", "重复设置", "学生错误解答", "错题解析", "标签"],
